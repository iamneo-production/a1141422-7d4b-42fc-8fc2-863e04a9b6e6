...
function Login() {
    ...
    async function login(event) {
        ...
        try {
          await axios.post("https://8080-adcaafbabeaaefafeabfcdcbbdbeaabbeaeaadbdbabf.project.examly.io/api/v1/custmlogin/login", {
            email: email,
            password: password,
            }).then((res) => 
            {
             ...
             { 
              ...
              console.log(customerEmail);
                ...
                axios.get(`https://8080-adcaafbabeaaefafeabfcdcbbdbeaabbeaeaadbdbabf.project.examly.io/customers/email/${customerEmail}`)
                  .then((response) => {
